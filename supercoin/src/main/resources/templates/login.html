...
<body>
	...
	<div class="animated bounceInDown">
		<div class="container">
			...
			<form name="form1" class="box" th:action="@{/login/authenticate}" th:object="${credential}" method="post">
			...
			<a th:href="@{register}" class="dnthave">Don’t have an account? Sign up</a>
		</div>
	</div>
